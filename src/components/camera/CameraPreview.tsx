        ...
        {!cameraActive && !attendanceMarked && !isProcessing && !error && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-[#1A1A1A] mb-2">Camera Ready</h3>
              <p className="text-xs sm:text-sm text-[#555]">Click Start Camera to begin.</p>
            </div>
          </div>
        )}
          ...
          <div className="absolute inset-0 flex items-center justify-center backdrop-blur-sm bg-red-50/90">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-2 mt-4">
                ...
                <span className="text-blue-600 text-sm font-medium">Redirecting...</span>
              </div>
            </div>
          </div>
        )}
        ...
        {isProcessing && !attendanceMarked && (
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
            <div className="text-center text-white">
              ...
              <p className="text-xs sm:text-sm font-medium">{cameraActive ? "Processing..." : "Starting Camera..."}</p>
            </div>
          </div>
        )}
        ...
        {attendanceMarked && (
          <div className="absolute inset-0 flex items-center justify-center bg-green-50">
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-[#1A1A1A] mb-2">Attendance Marked!</h3>
              <p className="text-xs sm:text-sm text-[#555] mb-4">Face recognized successfully.</p>
